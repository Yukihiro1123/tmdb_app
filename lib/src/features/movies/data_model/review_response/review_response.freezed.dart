...
class _$_ReviewResponse implements _ReviewResponse {
  ...
  @override
  String toString() {
    return 'ReviewResponse(page: $page, results: $results, totalResults: $totalResults, totalPages: $totalPages, errors: $errors)';
  }
...
abstract class _ReviewResponse implements ReviewResponse {
  factory _ReviewResponse(
      ...
      final List<String> errors}) = _$_ReviewResponse;
